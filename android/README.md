# Anagram Puzzle Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:anagrampuzzle-api:1.1.13'
}
```
...
```java
import com.apiverve.anagrampuzzle.AnagramPuzzleGeneratorAPIClient;
import com.apiverve.anagrampuzzle.APIResponse;
import com.apiverve.anagrampuzzle.APIException;

// Initialize the client
AnagramPuzzleGeneratorAPIClient client = new AnagramPuzzleGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("word", "listen");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/anagrampuzzle](https://docs.apiverve.com/ref/anagrampuzzle)
...
- **Documentation:** [https://docs.apiverve.com/ref/anagrampuzzle](https://docs.apiverve.com/ref/anagrampuzzle)
- **Issues:** [GitHub Issues](https://github.com/apiverve/anagrampuzzle-api/issues)
