...
namespace APIVerve.API.AnagramPuzzleGenerator
{
    ...
    /// <summary>
    /// Client for the AnagramPuzzleGenerator API
    /// </summary>
    public class AnagramPuzzleGeneratorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/anagrampuzzle";
        ...
        {
            { "word", new ValidationRule { Type = "string", Required = false } },
        ...
        public AnagramPuzzleGeneratorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AnagramPuzzleGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public AnagramPuzzleGeneratorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AnagramPuzzleGeneratorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(AnagramPuzzleGeneratorQueryOptions options)
        {
        ...
        public ResponseObj Execute(AnagramPuzzleGeneratorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(AnagramPuzzleGeneratorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(AnagramPuzzleGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(AnagramPuzzleGeneratorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(AnagramPuzzleGeneratorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(AnagramPuzzleGeneratorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(AnagramPuzzleGeneratorQueryOptions options)
        {
