...
// Request contains the parameters for the Anagram Puzzle Generator API.
//
// Parameters:
...
type Request struct {
	Word string `json:"word,omitempty"` // Optional
...
// ResponseData contains the data returned by the Anagram Puzzle Generator API.
