...
class TestAnagrampuzzleAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = AnagrampuzzleAPIClient(self.api_key)

    @patch('apiverve_anagrampuzzlegenerator.apiClient.requests.get')
