# Anagram Puzzle Generator API - Examples

This folder contains example code for using the Anagram Puzzle Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/anagrampuzzle',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/anagrampuzzle");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/anagrampuzzle](https://docs.apiverve.com/ref/anagrampuzzle)
